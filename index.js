...
const SUB_PATH = process.env.SUB_PATH || 'sub';       // 璁㈤槄璺緞
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http鏈嶅姟璁㈤槄绔彛
const UUID = process.env.UUID || '0de84996-8b33-4e02-9546-9b1e3c8e2642'; // 浣跨敤鍝悞v1,鍦ㄤ笉鍚岀殑骞冲彴杩愯闇€淇敼UUID,鍚﹀垯浼氳鐩�
